              ...
              <div className="product-card-content">
                <div className="product-card-price ">
                  ...
                  <span className="product-card-price-ong">
                    $14.99 <span className="product-card-price-oty">/Qty</span>{" "}
                  </span>
                </div>
                <div className="product-card-rating ">
                  <span className="product-card-rating-num">4.8</span>
          ...
          <div className="product-inner-item">
            <div className="product-card">
              ...
              <Link
                ...
                className="product-card-img"
              >
                <img src="assets/images/product-img3.png" alt="" />
              </Link>
              <div className="product-card-content">
                <div className="product-card-price ">
                  <span className="product-card-price-dec">
          ...
          <div className="product-inner-item">
            <div className="product-card">
              ...
              <Link
                ...
                className="product-card-img"
              >
                <img src="assets/images/product-img6.png" alt="" />
              </Link>
              <div className="product-card-content">
                <div className="product-card-price ">
                  <span className="product-card-price-dec">
